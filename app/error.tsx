...
export default function GlobalError({ error, reset }: ErrorPageProps) {
  return (
    <div className="mx-auto flex min-h-[50vh] max-w-3xl flex-col items-center justify-center px-4 py-16 text-center">
      <h1 className="font-display text-4xl text-ink dark:text-gray-100">Something went wrong</h1>
      ...
      <p className="mt-2 text-xs text-gray-400">{error.digest ? `Error ID: ${error.digest}` : 'Error ID unavailable'}</p>
      <button
        type="button"
        onClick={reset}
